...
$(function () {
    $('#datagrid_sbcx').datagrid({
        ...
        toolbar: [{
            ...
            text: '删除',
            handler: function () {
                var bsz = $('#datagrid_sbcx').datagrid('getChecked');
                if (bsz.length == 0) {
...
function btn_clear() {
    ...
    $('#sbcx_brandName').textbox('setValue', '');
    $('#sbcx_category').textbox('setValue', '');
    $('#sbcx_applyNumber').textbox('setValue', '');
    $('#sbcx_apply_date_start').datebox('setValue', '');
    $('#sbcx_apply_date_end').datebox('setValue', '');

    $('#datagrid_sbcx').datagrid('load', {
        brandName: $('#sbcx_brandName').val(),
        category: $('#sbcx_sort').val(),
        applyNumber: $('#sbcx_applyNumber').val(),
        apply_date_start: $('#sbcx_apply_date_start').datebox('getValue'),
        apply_date_end: $('#sbcx_apply_date_end').datebox('getValue'),
