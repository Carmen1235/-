...
$(function () {
    $('#datagrid_sbxk').datagrid({
        ...
        toolbar: [{
            ...
            text: '删除',
            handler: function () {
                var bsz = $('#datagrid_sbxk').datagrid('getChecked');
                if(bsz.length==0){
...
function btn_clear(){
    ...
    $('#sbxk_brandName').textbox('setValue','');
    $('#sbxk_category').textbox('setValue','');
    $('#sbxk_applyNumber').textbox('setValue','');
    $('#sbxk_apply_date_start').datebox('setValue','');
    $('#sbxk_apply_date_end').datebox('setValue','');

    $('#datagrid_sbxk').datagrid('load',{
        brandName:$('#sbxk_brandName').val(),
        category:$('#sbxk_category').val(),
        applyNumber:$('#sbxk_applyNumber').val(),
        apply_date_start:$('#sbxk_apply_date_start').datebox('getValue'),
        apply_date_end:$('#sbxk_apply_date_end').datebox('getValue'),
