...
<head>
    ...
    <!--导入外部JS-->
    <script type="text/javascript" src="js/sbcx.js" charset="utf-8"></script>
...
<div id="dialog_edit" class="easyui-dialog" title="编辑" style="width:100%;height:100%;"
    ...
    <form id="form_edit" method="post" >
        ...
        <div class="field">
            ...
            <img  id="brand_style"  src=""  ><a class="easyui-linkbutton" onclick="dialog_open_upload(4)">修改</a><input id="img_edit" name="brandStyle" style="display: none"><span style="color:red" id="message4"></span>
        </div>
        <div class="field">
        ...
        <div class="field">
            <label class="label">撤销方：</label><input type="text" class="easyui-textbox" name="cxf"/>
            <label class="label">被撤销方：</label><input type="text" class="easyui-textbox" name="bcxf"/>
        </div>
        <div class="field">
            <label class="label">撤销群组：</label><input type="text" class="easyui-textbox" name="cxqz"/>
            <label class="label">提撤销日期：</label><input id="cxrq" type="text" class="easyui-datebox" name="cxrq"
                                                      data-options="editable:false"/>
            <label class="label">撤销代理机构：</label><input type="text" class="easyui-textbox" name="cxdljg"/>
        </div>
        <div class="field">
            <label class="label">撤销结果：</label>
            <textarea class="easyui-textbox"
                      data-options="multiline:true"
                      style="width: 730px;height:200px;resize: none;" name="cxjg"></textarea>
        </div>
    </form>
</div>
<!--编辑的保存 取消按钮-->
...
<div id="dialog_add" class="easyui-dialog" title="新增" style="width:100%;height:100%;"
    ...
    <form id="form_add" method="post" >
        ...
        <div class="field">
            ...
            <input id="img_add" value="" name="brand_style"  style="display: none"><span style="color:red" id="message1"></span>
        </div>
        <div class="field">
        ...
        <div class="field">
            <label class="label">初审公告日：</label><input type="text" class="easyui-datebox" name="notice_date"
                                                      data-options="editable:false"/>
        ...
        <div class="field">
            <label class="label">撤销群组：</label><input type="text" class="easyui-textbox" name="cxqz"/>
            <label class="label">提撤销日期：</label><input type="text" class="easyui-datebox" name="cxrq"
                                                      data-options="editable:false"/>
            <label class="label">撤销代理机构：</label><input type="text" class="easyui-textbox" name="cxdljg"/>
        </div>
        <div class="field">
...
<<div data-options="region:'north',title:'查询'" style="height: 150px">
    <form id="form_sbcx_search" method="post">
        ...
        <div class="field">
            <label>商标名称：</label><input class="easyui-textbox" id="sbcx_brandName"/>
            <label>申请号：</label><input class="easyui-textbox" id="sbcx_applyNumber"/>
            <label>类别：</label><input class="easyui-textbox" id="sbcx_category"/>
            <label>申请日：</label>从<input class="easyui-datebox" id="sbcx_apply_date_start"/>到<input class="easyui-datebox" id="sbcx_apply_date_end"/>
...
<div data-options="region:'center',title:'显示数据'" >
    <table id="datagrid_sbcx" class="easyui-datagrid" data-options="pagination:true,nowrap:false,sortName:'brandName',sortOrder:'desc'" style="width: 100%;height: 100%">
        <thead>
        <tr>
            ...
            <th data-options="field:'groups',width:130,sortable:true" align="center">群组</th>
            ...
            <th data-options="field:'cxf',width:100,sortable:true" align="center">撤销方</th>
            <th data-options="field:'bcxf',width:150,sortable:true" align="center">被撤销方</th>
            <th data-options="field:'cxqz',width:100,sortable:true" align="center">撤销群组</th>
            <th data-options="field:'cxrq',width:100,formatter:dataFormatter,sortable:true" align="center">提撤销日期</th>
            <th data-options="field:'cxdljg',width:100,sortable:true" align="center">撤销代理机构</th>
            <th data-options="field:'cxjg',width:100,sortable:true" align="center">撤销结果</th>
        </tr>
        </thead>
    </table>
</div>
