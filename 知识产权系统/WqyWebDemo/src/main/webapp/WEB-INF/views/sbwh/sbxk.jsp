...
<head>
    ...
    <!--导入外部JS-->
    <script type="text/javascript" src="js/sbxk.js" charset="utf-8"></script>
</head>
...
<div id="dialog_edit" class="easyui-dialog" title="编辑" style="width:100%;height:100%;"
    ...
    <form id="form_edit" method="post">
        ...
        <div class="field">
            <label class="label">被许可方：</label><input type="text" class="easyui-textbox " name="bxkf"/>
            <label class="label">被许可期限：</label><input type="text" class="easyui-textbox " name="bxkqx"/>
            <label class="label">被许商品及服务：</label><input type="text" class="easyui-textbox " name="bxkspjfw"/>
        </div>
    </form>
</div>
<!--编辑的保存 取消按钮-->
...
<<div data-options="region:'north',title:'查询'" style="height: 150px">
    <form id="form_sbxk_search" method="post">
        <span id="hid_value_address">${address}</span>
        <div class="field">
            <label>商标名称：</label><input class="easyui-textbox" id="sbxk_brandName"/>
            <label>申请号：</label><input class="easyui-textbox" id="sbxk_applyNumber"/>
            <label>类别：</label><input class="easyui-textbox" id="sbxk_category"/>
            <label>申请日：</label>从<input class="easyui-datebox" id="sbxk_apply_date_start"/>到<input class="easyui-datebox" id="sbxk_apply_date_end"/>
...
<div data-options="region:'center',title:'显示数据'" >
    <table id="datagrid_sbxk" class="easyui-datagrid" data-options="pagination:true,nowrap:false,sortName:'brandName',sortOrder:'desc'" style="width: 100%;height: 100%">
        <thead>
        <tr>
            ...
            <th data-options="field:'category',width:70,sortable:true" align="center">类别</th>
            ...
            <th data-options="field:'bxkf',width:100,sortable:true" align="center">被许可方</th>
            <th data-options="field:'bxkqx',width:100,sortable:true" align="center">被许可期限</th>
            <th data-options="field:'bxkspjfw',width:100,sortable:true" align="center">被许商品及服务</th>
        </tr>
        </thead>
    </table>
</div>
