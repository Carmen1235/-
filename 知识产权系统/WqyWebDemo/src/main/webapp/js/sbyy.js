...
//
$(function () {
    var datagrid_sbyy = $('#datagrid_sbyy').datagrid({
        ...
        toolbar: [{
            ...
            text: '删除',
            handler: function () {
                var bsz = $('#datagrid_sbyy').datagrid('getChecked');
                if(bsz.length==0){
                ...
                $.ajax({
                    ...
                    success: function (r) {
                        ...
                        if(cbsdggr!=""){
                            ...
                            $("#cbsdggr").datebox('setValue',d2)
                        }
                        //设置提撤销日期
                        var tyyrq = r.obj.tyyrq;
                        if(tyyrq!=""){
                            var date = new Date(parseInt(tyyrq));
                            var d3 = date.getFullYear() + '-' + (date.getMonth() + 1) + '-' + date.getDate()+'  '+date.getHours()+":"+date.getMinutes();
                            $("#tyyrq").datebox('setValue',d3)//给授权公告日赋值
                        }
                    }
                });
...
function btn_clear(){
    ...
    $('#sbyy_brandName').textbox('setValue','');
    $('#sbyy_category').textbox('setValue','');
    $('#sbyy_applyNumber').textbox('setValue','');
    $('#sbyy_apply_date_start').datebox('setValue','');
    $('#sbyy_apply_date_end').datebox('setValue','');

    $('#datagrid_sbyy').datagrid('load',{
        brandName:$('#sbyy_brandName').val(),
        category:$('#sbyy_category').val(),
        applyNumber:$('#sbyy_applyNumber').val(),
        apply_date_start:$('#sbyy_apply_date_start').datebox('getValue'),
        apply_date_end:$('#sbyy_apply_date_end').datebox('getValue'),
