...
$(function () {
    $('#datagrid_sbzr').datagrid({
        ...
        toolbar: [{
            ...
            text: '删除',
            handler: function () {
                var bsz = $('#datagrid_sbzr').datagrid('getChecked');
                if(bsz.length==0){
            ...
            handler: function () {
                ...
                $.ajax({
                    ...
                    success: function (r) {
                        ...
                        //设置转让受理日
                        var zrslr = r.obj.zrslr;
                        if(zrslr!=""){
                            date = new Date(parseInt(zrslr));
                            var d3 = date.getFullYear() + '-' + (date.getMonth() + 1) + '-' + date.getDate()+'  '+date.getHours()+":"+date.getMinutes();
                            $("#zrslr").datebox('setValue',d3)//给疑似商标异议截止日
                        }
                        //设置转让受理日
                        var zrwcr = r.obj.zrwcr;
                        if(zrwcr!=""){
                            date = new Date(parseInt(zrwcr));
                            var d4 = date.getFullYear() + '-' + (date.getMonth() + 1) + '-' + date.getDate()+'  '+date.getHours()+":"+date.getMinutes();
                            $("#zrwcr").datebox('setValue',d4)//给转让受理日
                        }
                    }
                });
...
function btn_clear(){
    ...
    $('#sbzr_brandName').textbox('setValue','');
    $('#sbzr_category').textbox('setValue','');
    $('#sbzr_applyNumber').textbox('setValue','');
    $('#sbzr_apply_date_start').datebox('setValue','');
    $('#sbzr_apply_date_end').datebox('setValue','');

    $('#datagrid_sbzr').datagrid('load',{
        brandName:$('#sbzr_brandName').val(),
        category:$('#sbzr_category').val(),
        applyNumber:$('#sbzr_applyNumber').val(),
        apply_date_start:$('#sbzr_apply_date_start').datebox('getValue'),
        apply_date_end:$('#sbzr_apply_date_end').datebox('getValue'),
